...
| 토큰 | Hex | Tailwind | 용도 |
|------|-----|----------|------|
| `bg-primary` | `#070709` | 커스텀 | 앱 전체 배경 |
| `bg-card` | `#1C1C22` | - | 카드/섹션 배경 |
| `bg-card-alt` | `#24242A` | - | 서브카드, 입력필드 |
| `bg-elevated` | `#2C2C30` | - | 모달, 바텀시트 |
...
| `text-3` | `#9E9EA8` | 비활성, 힌트, 레이블 (WCAG AA 대비 확보) |
...
| Caption | 12px | 500 | 1.4 | 보조 정보 (최소 12px) |
...
| `radius-md` | 6px | 태그, 작은 버튼 (sm과 동일) |
| `radius-lg` | 12px | 카드, 입력필드 (모든 화면 통일) |
| `radius-xl` | 12px | lg와 동일 (실질적으로 6/12/full 3단계) |
