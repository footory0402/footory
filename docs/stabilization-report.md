...
| `docs/archive/2026-04-10/code-review.md` | archive 이동 | 중간 | 리뷰 체크리스트를 `AGENTS.md` 등에 흡수한 뒤 archive로 이동했다. |
...
| `docs/archive/2026-04-10/subagents.md` | archive 이동 | 낮음 | 제품/구현 기준 문서가 아니라 에이전트 운영 메모에 가깝고 `AGENTS.md`와 중복돼 archive로 이동했다. |
...
## 합칠 문서
- `AGENTS.md` + `docs/archive/2026-04-10/code-review.md`
  현재 작업 규칙과 리뷰 체크리스트의 기준 문장이 많이 겹쳐 상위 운영 규칙으로 흡수한 뒤 archive로 이동했다.
- `AGENTS.md` + `docs/archive/2026-04-10/subagents.md`
  이 문서는 코드/제품 기준 문서가 아니라 에이전트 운영 메모였고, 별도 기준본으로 두지 않고 archive로 이동했다.
...
- 다만 이 문서는 병합 대상 성격으로 판단돼 archive로 이동했다.
- `docs/archive/2026-04-10/code-review.md`는 병합 대상 성격으로 판단돼 archive로 이동했다.
