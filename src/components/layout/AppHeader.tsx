      ...
      <header className="sticky top-0 z-40 border-b border-white/5 glass-nav">
        ...
        <div className="flex h-[44px] items-center justify-between px-4">
          ...
          <div className="flex items-center -mr-1.5">
            ...
            <Link
              href="/dm"
              className="relative flex h-11 w-11 items-center justify-center rounded-full text-text-2 transition-colors active:bg-card"
              aria-label="메시지"
            >
            ...
            <Link
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full text-text-2 transition-colors active:bg-card"
              aria-label="설정"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
